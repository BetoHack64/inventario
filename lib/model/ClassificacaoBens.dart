class ClassificacaoBens {
  Cabecalho? cabecalho;
  RespostaServico? respostaServico;

  ClassificacaoBens({this.cabecalho, this.respostaServico});

  ClassificacaoBens.fromJson(Map<String, dynamic> json) {
...
class Lista {
  ...
  Lista({this.value, this.text, this.foreignKey});
